class Library :
    ...
    def lendBook(self,user,book):
            if book not in self.booksList:
                ...
                ("the book is already being used by {self.lendDict[book]}")
            else :
                self.lendDict[book] = user
                print('lender-book database has been updated. you can take the book now')
    def addBook(self,book):
        self.booksList.append(book)
        print(f"{book} has been dded to the book list")
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if user_choice == '1':
            ...
            book = input("Enter the name of the book you want to lend: ")books.lendBook(user_name, book)
        elif user_choice == '3':
            book = input("Enter the name of the book you want to add: ")books.addBook(book)
        elif user_choice == '4':
            book = input("Enter the name of the book you want to return: ")books.returnBook(book)
        elif user_choice == '5':
